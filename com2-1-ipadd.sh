...
#sleep 3
#echo "compute2-juno" > /etc/hostname
...
echo "########## Config IP address for compute2 ##########"
...
# MGNT NETWORK
auto $COM2_MGNT_IFACE
iface $COM2_MGNT_IFACE inet static
address $COM2_MGNT_IP	
netmask $NETMASK_ADD	

# EXT NETWORK
auto $COM2_EXT_IFACE
iface $COM2_EXT_IFACE inet static
address $COM2_EXT_IP	
...
# DATA NETWORK
auto $COM2_DATA_IFACE
iface $COM2_DATA_IFACE inet static
